...
/**
 * 
 * Factory for module-lib classes.
 * 
 * @author d3j766
 *
 */
public class ModuleIDSFactory implements DataSerializableFactory {
    ...
    public static final int MEMBER_LOCATION_TYPE = 10;
	...
	case (MEMBER_EXCHANGE_TYPE):
	    return cr.getExchangeLocations().new MemberExchange();
	case (MEMBER_LOCATION_TYPE):
	    return cr.getExchangeLocations().new MemberLocation();
	default:
	    return null;
	}
    }
