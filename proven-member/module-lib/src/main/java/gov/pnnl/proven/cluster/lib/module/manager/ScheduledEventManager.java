...
//
//	/**
//	 * Used to loads current schedules when manager is initialized. Should only
...
//
//	/**
//	 * Map of activated schedules (by scheduleId) and it's start time. This can
//	 * be used by work components to ensure only a single work component is
//	 * running at a time. TODO - Modify this to be based on a variable number of
//	 * concurrent work components. For now, used to manage single.
//	 */
//	private Map<Integer, Long> activatedSchedules = new HashMap<Integer, Long>();
//
//	/**
...
//					start(schedule);
//				}
//				ret = "Schedule changed (and restarted if it was active) " + Consts.NL + schedule.getName()
...
//				else {
//					String newSchedule = newSchedules.get(newSchedules.indexOf(schedule)).getSchedule();
...
//						log.debug("!!!!!!!!!!!!!!!!!!!!!  updating schedule :: " + schedule.getName());
//						schedule.setSchedule(newSchedule);
//						stop(schedule);
//						start(schedule);
//						log.debug("Schedule updated :: " + schedule.getName() + " :: Using new schedule :: "
//								+ newSchedule);
//
//					}
//				}
...
//			activatedSchedules.put(schedule.getScheduleId(), Utils.getLongForCurrentTime());
//			ret = true;
//		}
//		return ret;
//	}
...
//		log.debug("Removing schedule, Before..." + "ID:: " + schedule.getName() + "Name :: " + schedule.getScheduleId()
//				+ " Count :: " + activatedSchedules.size());
//		activatedSchedules.remove(schedule.getScheduleId());
//		log.debug("Removing schedule, After...: Count :: " + activatedSchedules.size());
//	}
//
...
//				ret += "Scheduled Attempts: " + schedule.getScheduledAttempts() + Consts.NL;
//				ret += "-----------------------------------" + Consts.NL;
//				ret += Consts.NL;
//			}
//		}
...
//		boolean ret = false;
//		for (Schedule schedule : getSchedules()) {
//			if ((schedule.getIsMaintenance()) && (schedule.getStatus() == MaintenanceStatus.ON)) {
//				ret = true;
//				break;
//			}
//		}
...
//	 * Schedule.workComponent value, and an asynchronous doWork(Schedule) method
...
//
//						if (schedule.getScheduledAttempts() < pm.getMaxScheduledMaintenanceAttempts()) {
...
//				log.debug(methodName + " invoked for ejb :: " + schedule.getWorkComponent() + ", for schedule "
//						+ schedule.getName());
//			} catch (Exception e) {
//				log.error(methodName + " method not found or invocation failed for schedule :: " + schedule.getName());
//				e.printStackTrace();
//			}
//		} else {
